...
function januari() {
    ...
    startDienst = [...startDienst.splice(16), ...startDienst];
    var datum = [],
...
function februari() {
    ...
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(19), ...startDienst];
    var datum = [],
...
function mei() {
    ...
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(25), ...startDienst];
    var datum = [],
...
function juni() {
    ...
    //startDay = [...startDay.splice(5), ...startDay];
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(28), ...startDienst];
    var datum = [],
...
function augustus() {
    ...
    startDay = [...startDay.splice(5), ...startDay];
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(5), ...startDienst];
    var datum = [],
...
function september() {
    ...
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(8), ...startDienst];
    var datum = [],
...
function oktober() {
    ...
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(10), ...startDienst];
    var datum = [],
...
function november() {
    ...
    startDay = [...startDay.splice(6), ...startDay];
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(13), ...startDienst];
    var datum = [],
