...
function maart() {
    ...
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(6), ...startDienst];
    var datum = [],
...
function mei() {
    ...
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(11), ...startDienst];
    var datum = [],
...
function juni() {
    ...
    //startDay = [...startDay.splice(5), ...startDay];
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(14), ...startDienst];
    var datum = [],
...
function oktober() {
    ...
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(24), ...startDienst];
    var datum = [],
...
function december() {
    ...
    startDay = [...startDay.splice(1), ...startDay];
    let startDienst = [...dienst];
    startDienst = [...startDienst.splice(1), ...startDienst];
    var datum = [],
